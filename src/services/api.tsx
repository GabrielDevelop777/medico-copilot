// @ts-nocheck
// NOTA: O seu arquivo api.ts não estava completo, 
// então juntei todas as funções que criamos. 
// Verifique se falta alguma.
...
// Rota 4
export const enviarMensagemChatService = async (mensagem: string, contexto: any) => {
  // CORREÇÃO AQUI
